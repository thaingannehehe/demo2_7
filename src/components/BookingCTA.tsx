  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[800px] text-center">
        ...
        >
          Hãy để chúng tôi chăm sóc mái tóc của bạn. Đặt lịch hẹn để nhận tư vấn cá nhân hóa, chọn kiểu tóc và dịch vụ phù hợp, và trải nghiệm dịch vụ cao cấp tại Triệu Tóc Đẹp.
        </p>
        <div className="mt-10">
          <a
